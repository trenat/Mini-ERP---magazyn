...
namespace MiniERP_desktop.Services
{
    public class InvoicerApi : IInvoicerApi
    {
        ...
        public Document GenerateDocumenteWithoutSave()
        {
            return new PdfInvoice(Invoice).GenerateWithoutSave();
        }
    }
    ...
    public interface IInvoicerActions
    {
        ...
        /// <summary>
        /// Generate just document
        /// </summary>
        Document GenerateDocumenteWithoutSave();
    }
}
